...
you can access the command line arguments as an array using the `getArguments()` function 
...
awl is meant to be used in any scripting environment desired, to configure awl for your own use case 
you might need to modify certain parts of the interpreter 
